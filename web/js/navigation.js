...
var _routes = {
    ...
    'notification-settings': { nav: 'profile', showNav: true },
    ...
    'clubs':        { showNav: true, init: function() { if (typeof loadClubsScreen === 'function') loadClubsScreen(); } },
    'club-detail':  { showNav: true, init: function() { if (typeof loadClubDetailScreen === 'function') loadClubDetailScreen(); } },
    'club-create':  { showNav: true, init: function() { if (typeof initClubCreateForm === 'function') initClubCreateForm(); } },
    'club-invite':  { showNav: true, init: function() { if (typeof loadClubInviteScreen === 'function') loadClubInviteScreen(); } },
    'club-post-form': { showNav: true, init: function() { if (typeof initClubPostForm === 'function') initClubPostForm(); } },
    'club-schedule-form': { showNav: true, init: function() { if (typeof initClubScheduleForm === 'function') initClubScheduleForm(); } },
    'post-detail':   { nav: 'posts', showNav: true },
    'member-detail': { nav: 'members', showNav: true },
    'meeting-records': { showNav: true, init: function() { if (typeof loadMeetingRecordsScreen === 'function') loadMeetingRecordsScreen(); } }
};
